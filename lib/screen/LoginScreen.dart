...
class _LoginscreenState extends State<Loginscreen> {
  ...
  final List<String> hintText = ['Email or mobile number', 'Password'];

  final List<String> lableText = [
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(faIcons[index]),
                                    hintText: hintText[index],
                                    labelText: lableText[index],
                        ...
                        Text('you have not account? SignUp')
                      ],
                    ),
                  ],
                )
